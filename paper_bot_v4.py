"""
Automated Paper Trading Bot - V4 Fast Donchian Strategy
Runs on Binance Testnet with real-time 1H monitoring
"""
import time
import logging
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('paper_bot_v4.log'),
...
class PaperTradingBot:
    """Automated paper trading bot for V4 strategy"""
    ...
    def __init__(self, initial_capital: float = 1000.0, check_interval: int = 3600):
        ...
        self.params.entry_len = 8
        self.params.exit_len = 16
        self.params.trail_mult = 3.5
        self.params.atr_len = 14
        ...
        logger.info(f"Strategy: V4 Fast Donchian")
...
if __name__ == "__main__":
    ...
    CHECK_INTERVAL = 3600  # Check every hour for 1H candles update
